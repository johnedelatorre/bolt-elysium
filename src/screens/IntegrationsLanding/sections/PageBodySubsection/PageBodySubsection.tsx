...
export const PageBodySubsection = (): JSX.Element => {
  ...
  return (
    <div className="flex-1 overflow-auto bg-[#1a1d23] text-white h-screen">
      {/* Header with breadcrumbs left and buttons right */}
      <div className="bg-[#1d1e24] border-b border-[#303030] px-4 py-0 flex items-center justify-between h-12">
        {/* Breadcrumbs - Left side */}
        <div className="flex items-center space-x-2">
          <span className="text-gray-400 text-sm">Integrations</span>
          <span className="text-gray-500">/</span>
          <span className="text-gray-400 text-sm">Browse Integrations</span>
          <span className="text-gray-500">/</span>
          <span className="text-blue-400 text-sm">Breadcrumb</span>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="px-4 py-1 bg-[#053C5A] text-white text-sm rounded hover:bg-[#064a6b] transition-colors flex items-center">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-1">
              <path d="M12 3L4 6.5V12C4 16.5 7.5 20.75 12 22C16.5 20.75 20 16.5 20 12V6.5L12 3Z" fill="currentColor"/>
            </svg>
            Save changes
          </button>
        </div>
